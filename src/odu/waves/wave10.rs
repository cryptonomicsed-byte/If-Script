//! WAVE 10 — Restraint / x  (indices 144–159)
...
pub const WAVE: [Odu; 16] = [
    ...
    Odu { index: 152, binary: 0b10011000,
        ...
        prescriptions: &["Use a machete to clear brush in ritual", "Offer iron tools to the Forge Executor"],
        archetypes: &["Justice Canon", "Forge Executor"],
        interpretation_type: "synthetic",
    ...
    Odu { index: 159, binary: 0b10011111,
        ...
        archetypes: &["Flow Guardian", "Prime Source"],
        interpretation_type: "synthetic",
