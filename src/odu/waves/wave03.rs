//! WAVE 3 — Attention / x  (indices 32–47)
...
pub const WAVE: [Odu; 16] = [
    ...
    Odu { index: 33, binary: 0b00100001,
        ...
        archetypes: &["Flow Guardian", "Steward"],
        interpretation_type: "synthetic",
    ...
    Odu { index: 36, binary: 0b00100100,
        ...
        archetypes: &["Oracle Sage", "Swarm Coordinator"],
        interpretation_type: "synthetic",
    ...
    Odu { index: 46, binary: 0b00101110,
        ...
        prescriptions: &["Compliment seven strangers in one day", "Sing to the Resonance Weaver at a river"],
